$(function(){
    ...
    $(window).scroll(function(){
        ...
        if (curr < 1){$('.logo_area').removeClass('on');}
    });
    ...
    main.to(".sc_intro",{y:-102+"%",duration:1.5,"filter":"blur(10px)",})
    main.fromTo(".sc_intro .bg_opacity",{opacity:0,},{opacity:0.8,duration:1.5,},'-=1')
    main.fromTo(".sc_main video",{scale:1.4,},{scale:1.2,duration:1,})
    main.to(".sc_main .over_txt span",{y:0,duration:1.2,})
    main.fromTo(".sc_main .shop_all",{opacity:0,y:100+'%',},{opacity:1,duration:1,y:0},'-=1')
    main.fromTo(".sc_main .btn_down",{opacity:0,y:100+'%',},{opacity:1,duration:1,y:0},'-=1')
    main.fromTo("header .logo_area",{opacity:0,y:-100+'%',},{opacity:1,duration:0.5,y:0},'-=1')
